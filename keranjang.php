            ...
            if(isset($cart[$pid]))
            	if ($_GET['qty'] >= 1)
	                $cart[$pid] = $_GET['qty'];
	           		...
	           		alert('Maaf Quantiti harus diisi'); redir('keranjang.php');
...
<?php } } ?>
       ...
       <p><form action="<?php echo  $url.'order.php' ?>" method="POST"> 
	   ...
	   <button class="btn btn-info btn-sm "><a href="<?php echo $url ?>"> lanjut Belanja</a></button>
		</p>
	</div>
