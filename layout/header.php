...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid a" stylle="background:white;">
      <div class="row">
        <div class="col-4">
        adaswewfrw3twry
        </div>
        <div class="col-8">
          <div class="row">
            <div class="col">brtewgtrhethythehhet</div>
            <div class="col">cgrthjteyee</div>
            <div class="w-100">aegrtw3gww4g45</div>
            <div class="col">dgw5gy4hwh4</div>
          </div>
        </div>
      </div>
    </div>
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse"> 
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="<?php echo $url ?>menu.php">Daftar Buku</a></li> 
